                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    @foreach($building->floors as $floor)
                        <div class="panel panel-default">
                            ...
                            <div id="collapse{{ $floor->level }}" class="panel-collapse collapse" role="tabpanel"
                                 aria-labelledby="heading{{ $floor->level }}">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-xs-12">
                                                                ...
                                                                <h4 class="h4-label">
                                                                    <span class="label label-success pull-left">{{ $room->freeSpots() }}
                                                                        beschikbare plekken</span>
                                                                </h4>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            @if(count($room->users) ==0)
                                                                <div class="col-xs-12">
                                                                    <p style="height: 115px;">Deze kamer is nog helemaal
                                                                        leeg.</p>
                                                                </div>
                                                            @endif
