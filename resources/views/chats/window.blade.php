                ...
                <div class="panel panel-default">
                    <div class="panel-heading top-bar">
                        <div class="col-md-8 col-xs-8">
                            <h3 class="panel-title"><i class="fa fa-comment"></i> <span style="margin-left: 50px;">Conversation with <strong>{{ $otherUser->name }}</strong></span></h3>
                        </div>
                    </div>
                            ...
                            <div class="row msg_container base_receive">
                                ...
                                <div class="col-md-10 col-xs-10">
                                    <div class="messages msg_sent">
                                        <p>{{ $message->message }}</p>
                                        <time datetime="2009-11-13T20:00">{{ $message->user->name }} • {{ date("H:i") }}</time>
                                    </div>
                                </div>
                            </div>
                        @else
